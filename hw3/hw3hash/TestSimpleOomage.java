...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        ...
        assertNotEquals(ooA5.hashCode(), ooA.hashCode());
        SimpleOomage ooA6 = new SimpleOomage(5, 20, 10);
        assertNotEquals(ooA2.hashCode(), ooA6.hashCode());
        SimpleOomage ooA7 = new SimpleOomage(5, 5, 25);
        assertNotEquals(ooA.hashCode(), ooA7.hashCode());
    }
