...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage castedObject= (SimpleOomage) o;
        return (this.red == castedObject.red) && (this.green == castedObject.green) && (this.blue == castedObject.blue);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return red / 3 ^ 31 - green / 3 ^ 31 + blue / 3 ^ 31;
        }
    }
